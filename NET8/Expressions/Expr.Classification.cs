...
namespace JA.Expressions
{
    public partial record Expr
    {
        ...
        public bool IsJaggedMatrix(out Expr[][] elements)
        {
        ...
        public bool IsConstMatrix(out JaggedMatrix matrix)
        {
            matrix = null;
            if (IsJaggedMatrix(out var exprMatrix))
            {
                ...
                matrix = new JaggedMatrix(elements);
                return true;
            }
            return false;
        }
